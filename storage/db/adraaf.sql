...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 11, 2015 at 12:32 PM
...
(1, 'info@hilandbeauty.com', '7c222fb2927d828af22f592134e8932480637c0d', 'فروشگاه عطر هایلند', 'تهران، شهرک قدس، ابتدای بلوار فرحزادی، مجتمع تجاری میلاد نور، طبقه ششم', '1.png', 35.753497, 51.362583, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 'golestan@nikekish.ir', '7c222fb2927d828af22f592134e8932480637c0d', 'فروشگاه نایک', 'شهرک غرب، ابتدای خیابان ایران زمین، مرکز تجاری گلستان', '2.jpg', 35.753427, 51.374265, 5, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(3, 'info@starbucks.ir', '7c222fb2927d828af22f592134e8932480637c0d', 'کافه استارباکس', 'شهرک غرب، ابتدای خیابان ایران زمین، روبروی مهستان، مرکز تجاری ایران زمین', '3.png', 35.752774, 51.373385, 3, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(4, 'info@dahe60.ir', '7c222fb2927d828af22f592134e8932480637c0d', 'کافه دهه شصت', 'شهرک غرب، ابتدای خیابان ایران زمین، نرسیده به مهستان، پلاک 40', '4.jpg', 35.75327, 51.371937, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
(1, 'arsalan@yarveisi.com', '7c222fb2927d828af22f592134e8932480637c0d', '275cc80b-0fb2-4d53-b54a-513867af0a6e', '2015-09-01 19:30:00', '2015-09-01 19:30:00'),
(2, 'sadjad@fallah.com', '7c222fb2927d828af22f592134e8932480637c0d', '275cc80b-0fb2-4d53-b54a-513867af0a6f', '2015-09-01 19:30:00', '2015-09-01 19:30:00'),
(3, 'omid@jafari.com', '7c222fb2927d828af22f592134e8932480637c0d', '275cc80b-0fb2-4d53-b54a-513867af0a6g', '2015-09-01 19:30:00', '2015-09-01 19:30:00'),
(4, 'ali@motameni.com', '7c222fb2927d828af22f592134e8932480637c0d', '275cc80b-0fb2-4d53-b54a-513867af0a6h', '2015-09-01 19:30:00', '2015-09-01 19:30:00'),
(5, 'marathon@sharif.edu', '7c222fb2927d828af22f592134e8932480637c0d', '275cc80b-0fb2-4d53-b54a-513867af0a6i', '2015-09-01 19:30:00', '2015-09-01 19:30:00');
...
--
ALTER TABLE `offers`
  ADD PRIMARY KEY (`id`), ADD KEY `offers_store_id_foreign` (`store_id`);

--
-- Indexes for table `stores`
--
ALTER TABLE `stores`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `stores_email_unique` (`email`), ADD KEY `stores_category_id_foreign` (`category_id`);

--
-- Indexes for table `users`
--
ALTER TABLE `users`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `users_email_unique` (`email`), ADD UNIQUE KEY `users_uuid_unique` (`uuid`);

--
-- Indexes for table `user_actions`
--
ALTER TABLE `user_actions`
  ADD KEY `user_actions_user_id_foreign` (`user_id`), ADD KEY `user_actions_action_id_foreign` (`action_id`), ADD KEY `user_actions_offer_id_foreign` (`offer_id`);

--
-- Indexes for table `user_levels`
--
ALTER TABLE `user_levels`
  ADD KEY `user_levels_user_id_foreign` (`user_id`), ADD KEY `user_levels_level_id_foreign` (`level_id`);
